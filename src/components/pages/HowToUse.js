  ...
  return (
    <PagesContent>
      ...
      <p className={classes.description}>
        ...
        <span className={classes.bold}>nowe</span>", a następnie wybrać przycisk
        "<span className={classes.bold}>wygeneruj</span>":
        <br />
        <img className={classes.img} src={generateBtn}></img>
        <br />
        Wyświetlone słowo można pominąć klikając przycisk "
        <span className={classes.bold}>pomiń</span>" wówczas nie pojawi się ono
        ponownie:
        <br />
        ...
        dodano słowa w sekcji "<span className={classes.bold}>nowe</span>". Po
        zakończeniu należy dodać słówka do historii. Można je przejrzeć w sekcji
